...
def onValueChange(channel, sampleIndex, val, prev):
    ...
    # Si MediaPipe ET main inactive, envoyer hero très loin (rétractation auto)
...
# 3. Rétractation auto: Si MediaPipe + main inactive → hero à (-5000, -5000)
#    → Le HTML calcule dist > 480px → Rétractation automatique des bridges
